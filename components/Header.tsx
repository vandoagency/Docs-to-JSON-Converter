          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              <button
                ...
                className="hidden sm:flex px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 text-sm font-semibold hover:bg-blue-100 transition-colors items-center gap-2 border border-blue-100"
              >
